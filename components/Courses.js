                            ...
                            <Link href={"/volume/" + row.volume + "/issue/" + row.issue + "/"}><a>
                                <div className="course-one__single">
                                    <div className="course-one__image">
                                        <img src={require("../public/doc/ijepem-"+ moment(row.year).format("YY") +"-0" + row.issue + "-00-00.png")}
                                             alt="volume image"/>
                                    </div>
                                    <div className="course-one__content">
                                        ...
                                        <div className="course-one__meta">
                                            <a><i className="far fa-calendar"></i> {moment(row.year).format("DD.MM.YYYY")}</a>{" "}
                                            <a><i className="far fa-folder-open"></i> {row.articles.length} Article</a>
                                        </div>
                                    </div>
                                </div>
                            </a></Link>
